...
const PIPELINE_VERSION: &str = "augustus-ktx2-v2-icons-sha256";
const MANIFEST_NAME: &str = ".augustus-assets";
...
fn parse_options() -> Result<Options, String> {
    let mut options = Options {
        jobs: env::var("AUGUSTUS_ASSET_JOBS")
            .ok()
...
/// Converts stale source images with at most twelve single-threaded encoder workers.
...
/// Encodes one source image to an atomically replaced sRGB UASTC/Zstd KTX2 texture.
