//! Augustus's fixed public Supabase configuration.
...
impl SupabaseConfig {
    ...
    /// Returns Augustus's built-in public Supabase configuration.
...
pub enum ConfigError {
    ...
    #[error("a Supabase secret/service-role key must never be shipped with Augustus")]
    SecretKeyRejected,
}
